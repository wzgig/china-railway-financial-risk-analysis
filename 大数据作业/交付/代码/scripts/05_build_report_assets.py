...
FIGURE_ASSETS = [
    ...
    (
        "数据图1",
        "节点类型与边类型分布图",
        FIGURE_DIR / "data_type_distribution.png",
        "说明 nodes.csv 与 edges.csv 的类型构成，支撑数据集结构说明。",
    ),
    (
        "数据图2",
        "节点与边证据等级分布图",
        FIGURE_DIR / "evidence_level_distribution.png",
        "说明公开资料、公司披露、行业逻辑和结构化模拟在数据集中的占比。",
    ),
    (
        "数据图3",
        "阶段新增节点与边分布图",
        FIGURE_DIR / "stage_increment_distribution.png",
        "展示 2024-2027 年各阶段新增节点、新增边和平均边权重变化。",
    ),
    (
        "交互图",
        "算电协同价值网络交互 HTML",
