...
| 日期 | 数据库或网站 | 检索式 | 筛选条件 | 结果 | 下一步 |
|---|---|---|---|---|---|
| 2026-06-29 | 东方财富 HSF10 财务分析接口 | 中国中铁、中国铁建、中国交建、中国建筑、中国电建、中国能建、上海建工、隧道股份、安徽建工、中国化学、中国中冶 | A 股建筑工程类公司、2021-2025 年报 | 采集 11 家公司、55 条年度财务面板记录 | 后续如需终稿，可抽样与年报或交易所公告核验 |
| 2026-06-29 | 本地 scikit-learn | Logistic Regression；Random Forest；financial distress warning | 时间切分、下一年压力标签、F1/Recall/AUC | 形成 44 条监督学习样本，训练两个财务预警基线模型 | 后续可加入同业文本和事件特征 |
